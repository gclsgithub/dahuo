...
public class ResultMessages implements Serializable {
     ...
     */
    public ResultMessages(String code, Object[] args, String text) {
        this.code = code;
     ...
     */
    public static ResultMessages fromCode(String code, Object... args) {
        Assert.notNull(code, "code must not be null");
        return new ResultMessages(code, args, null);
    }
     ...
     * @return ResultMessage instance
     */
    public static ResultMessages fromCode(IErrors<?> code, Object... args) {
        Assert.notNull(code, "code must not be null");
        return new ResultMessages(code.name(), args, code.getMessage());
    }
     ...
     * @return ResultMessage instance
     */
    public static ResultMessages fromText(String text) {
        Assert.notNull(text, "text must not be null");
        return new ResultMessages(null, EMPTY_ARRAY, text);
    ...
    public boolean equals(Object obj) {
        ...
        ResultMessages other = (ResultMessages) obj;
        if (code == null) {
            if (other.code != null) {
                return false;
            }
